...
def vtv(
    ...
    try:
        ...
        # Export as MP3
        edge_output_filename = "output_voice.mp3"
        audio_segment.export(edge_output_filename, format="mp3")
        print("tanignaaaaaaaaaaaa")
        print(edge_output_filename)
