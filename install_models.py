...
!aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/gjin10969/rvc-model-sample/resolve/main/Aoyagisan/AoyagiVoice2YS.Speech.pth -d /root/jonathan_codev_tts/weights/eli -o eli_sterio.pth
